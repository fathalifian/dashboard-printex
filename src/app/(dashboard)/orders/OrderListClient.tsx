...
import { deleteOrderAction, SupabaseOrder } from '@/app/actions/order'
...
export default function OrderListClient({ initialOrders }: { initialOrders: SupabaseOrder[] }) {
  const [search, setSearch] = useState('')
  const [activeFilter, setActiveFilter] = useState('all')
  const [pendingDeleteId, setPendingDeleteId] = useState<string | null>(null)
  
  // Gunakan initialOrders dari Supabase Server (props)
  ...
  async function confirmDelete() {
    ...
    // Hapus via Supabase Server Action
    await deleteOrderAction(idToDelete)
  }
